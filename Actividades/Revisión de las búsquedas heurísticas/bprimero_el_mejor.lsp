...
;;;**************************************************************************
;;; Representación de los nodos heurísticos
;;;**************************************************************************

;;; Los nodos heurísticos se componen de:
;;; - un estado,
;;; - un camino (que es la lista de operadores que para transformar el
;;;   estado inicial en el actual, escrita en orden inverso) y
;;; - el valor de la función de evaluación heurística del estado actual.
...
;;;**************************************************************************
;;; Procedimiento de búsqueda por primero el mejor
;;;**************************************************************************
...
;;;         cuya heurística es la del estado inicial);
...
;;;                      nodos por orden creciente de sus heurísticas.
...
;;;   ordenados de menor a mayor heurística.
